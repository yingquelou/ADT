...
#define LIST_API
	...
	LIST_API ListNode *listBegin(ListNode *);
	// 链表存在的话返回其尾结点，否则返回空指针
	LIST_API ListNode *listEnd(ListNode *);
	/**
	 ...
	 */
	LIST_API ListNode *listInsertAfterNode(ListNode *node, void *d);
	/**
	 ...
	 * \date by yingquelou at 2023-09-17 10:38:23
	 */
	LIST_API ListNode *listInsertBeforeNode(ListNode *node, void *d);
	/**
	 ...
	 */
	LIST_API ListNode *listPushBack(List, void *);
	LIST_API ListNode *listPushFront(List, void *);
	 ...
	 */
	LIST_API void listForEach(ListNode *, listOperator, void *);
	/**
	 ...
	 */
	LIST_API List listMap(ListNode *, listOperator, void *);
	/**
	 * \brief 销毁链表
	 ...
	 */
	LIST_API void listDestroy(ListNode *, listOperator, void *);
	/**
	 ...
	 */
	LIST_API ListNode *listSearch(ListNode *, listOperator, void *);
	/**
	 ...
	 */
	LIST_API ListNode *listDeleteNode(ListNode *, void **);
	LIST_API ListNode *listPopFront(ListNode *, void **);
	LIST_API ListNode *listPopBack(ListNode *node, void **pData);
#endif
#ifdef __cplusplus
}
#endif